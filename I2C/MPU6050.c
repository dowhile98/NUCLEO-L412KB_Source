...
static I2C_TypeDef *i2cHandler;

//Fucntion Definitions
//1- i2c Handler 
void MPU6050_Init(I2C_TypeDef *I2Chnd)
{
...
void I2C_Read(uint8_t ADDR, uint8_t *i2cBif, uint8_t NofData)
{
	...
	I2C_SendData(i2cHandler,MPUADDR,i2cBuf,1);
	//HAL_I2C_Master_Transmit(&i2cHandler, MPUADDR, i2cBuf, 1, 10);
	I2C_ReceiveData(i2cHandler,MPUADDR,i2cBif,NofData);
...
void I2C_Write8(uint8_t ADDR, uint8_t data)
{
	...
	I2C_SendData(i2cHandler, MPUADDR, i2cData, 2);
